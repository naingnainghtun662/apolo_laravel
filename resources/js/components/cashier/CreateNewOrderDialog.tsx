...
export default function CreateNewOrderDialog() {
    const {
        filters,
        tables,
        categories = [],
            ...
            <DialogContent className="max-h-[95vh] min-h-[60vh] min-w-full p-0">
                <div className="flex gap-2 border-b p-4">
                    ...
                    <div>
                        ...
                        <Select value={orderType} onValueChange={(value) => setOrderType(value)}>
                            ...
                            <SelectContent>
                                <SelectItem value={'dine_in'} key={'dine_in'}>
                                    Dine in
                                </SelectItem>
                                <SelectItem value={'take_out'} key={'take_out'}>
                                    Take out
                                </SelectItem>
                            </SelectContent>
                        </Select>
                ...
                <div className="mt-[-16px] flex">
                    ...
                    <div className="w-[30vw] border">
                        <AddedOrderItems tableId={table} orderType={orderType} />
                    </div>
                </div>
            </DialogContent>
        </Dialog>
